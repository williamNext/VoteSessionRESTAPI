...
public class PollSession {
	...
	public Long countYesVotes() {
		...
		long count = votes.stream().filter(vote -> vote.getOptionVote().equals(OptionVote.YES)).count();
	...
	public Long countNoVotes() {
		...
		long count = votes.stream().filter(vote -> vote.getOptionVote().equals(OptionVote.NO)).count();
